package me.muawb.effect.particle;
...
public class Effects {
    ...
    public void noteParticle(Player p){
        String s = plugin.getConfig().getString("Settings.Note.power");
    ...
    public void slimeParticle(Player p){
        String s = plugin.getConfig().getString("Settings.Slime.power");
    ...
    public void critMagicParticle(Player p){
        String s = plugin.getConfig().getString("Settings.CritMagic.power");
